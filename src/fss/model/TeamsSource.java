...
public class TeamsSource {
    ...
    public TeamsSource(int sourcePrevID, SchemePart.TypeSourcePrev typeSourcePrev, int cntTeamTypeSourcePrev) {
        ...
        if(typeSourcePrev == SchemePart.TypeSourcePrev.N_TEAM)
            this.teamN = cntTeamTypeSourcePrev;
        else
            this.cntTeam = cntTeamTypeSourcePrev;
    }
